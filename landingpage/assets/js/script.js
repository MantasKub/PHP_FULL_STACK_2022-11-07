...
document.querySelectorAll(".tabs-nav li").forEach((el) => {
  const target = el.dataset.targer;
...
document.querySelectorAll("section.pricing .pricing-buttons button").forEach((el) => {
  el.addEventListener("click", (event) => {
    document.querySelector(
      "section.pricing [data-plan='basic'] .amount"
    ).textContent = el.dataset.basic;
    document.querySelector(
      "section.pricing [data-plan='standard'] .amount"
    ).textContent = el.dataset.standard;

    document.querySelectorAll("section.pricing .pricing-buttons button")
      .forEach((button) => {
